...
import licenta from "../../assets/images/TPMS_ss.png";
import blockchain from "../../assets/images/blockchain-project.png";
import chefai from "../../assets/images/ClaudeAI.png";
...
const cardData = [
  ...
  },
  {
    color: "#060010",
    title: "ChefAi",
    description: "•Claude 3 Haiku •React •API Integration",
    label: "AI Assistant",
    image: chefai,
    link: "https://github.com/mateipop/ChefAI",
  },
  {
    color: "#060010",
  ...
  {
    color: "#060010",
    title: "Water Source App",
    description: "•Leadership •React Native •Geo-location",
    label: "Contest Winner",
    image: adventuregame,
    link: "https://github.com/mateipop/WaterSource", // Replace with your actual link
  },
];
...
const ParticleCard = ({
  ...
  useEffect(() => {
    ...
    const handleClick = (e) => {
      ...
      // Programmatic Navigation (ensures links work even with custom logic)
      if (link && link !== "#") {
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid gap-2 p-3 max-w-[84rem] mx-auto select-none relative"
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative min-h-[260px] w-full max-w-full p-6 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_12px_30px_rgba(0,0,0,0.18)] ${
            ...
            // CASE 1: With Star Particles (Now supports links)
            if (enableStars) {
              return (
                <ParticleCard
                  key={index}
            ...
            // CASE 2: Static fallback (Also updated for links)
            return (
              <a
                href={card.link}
                target="_blank"
